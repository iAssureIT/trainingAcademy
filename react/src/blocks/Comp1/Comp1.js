		...
		return (
			<div>
				<div className="col-lg-12 col-md-12 hidden-xs hidden-sm">
					<div className="col-lg-12  col-md-12 c1box1 hidden-xs hidden-sm">
						<div className="col-lg-6 col-md-6 part1box1 nopadding">
							<div className="row"> 
				...
				<div className="col-xs-12 col-sm-12 hidden-lg hidden-md">
					<div className="col-xs-12 col-sm-12 c1box1Mobile ">
						<div className="col-xs-12 col-sm-12 part1box1 nopadding">
							<div className="row"> 
								<div className="col-xs-12 col-sm-12">
								 <div className="col-lg-12 blockicon">
						...
						<div className="col-xs-12 col-sm-12 part2box1">
